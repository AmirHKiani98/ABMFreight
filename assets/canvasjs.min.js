    ...
    function hb(h) {
        if (!ib) {
            ...
            "undefined" === typeof pa.Chart.creditHref ?
                (h.creditHref = X("iuuqr;..b`ow`rkr/bnl."), h.creditText = X("B`ow`rKR/bnl")) : (m = h.updateOption("creditText"), w = h.updateOption("creditHref"));
    ...
    var fb = function() {
        ...
        ea = function(h, m, w) {
            ...
            for (J = F = L = Q = N = 0; 0 < M.length;)
                ...
                (w = y + w)) : w = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + w : m + w : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), w += m.replace(/[0]+/, function(a) { return Y(V, a.length) }));
            y = "";
            for (M = !1; 0 < T.length;) m = T.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ? (y += h.shift(), M = !0) : "0" === m && (y += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length -
                1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), y += m.replace(/[0]+/, function(a) { return Y(V, a.length) }));
            w += (M ? u : "") + y;
            return s ? "-" + w : w
        },
        Na = function(h) {
                        ...
                        for (var B = !1, t = 0; t < n.length; t++)
                            if (x = n[t].getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                                ...
                                if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || B || m) && (c.stroke(), u && b.stroke()), B = !0;
                                    ...
                                    if (0 < n[t].markerSize || 0 < k.markerSize) C = k.getMarkerProperties(t, x, s, c), f.push(C), z = Q(z), u && f.push({ x: x, y: s, ctx: b, type: C.type, size: C.size, color: z, borderColor: z, borderThickness: C.borderThickness });
                            ...
                            if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin ||
                                ...
                                if ("number" !== typeof r[h].y) g.connectNullData || (ja || d) || b(), ja = !0;
                                    ...
                                    d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, C = n, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, t), u && l.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), u &&
                                        (l.beginPath(), l.moveTo(m, t)), C = { x: m, y: t }), ja = d = !1) : (f.lineTo(m, t), u && l.lineTo(m, t), 0 == h % 250 && b());
                                    n = { x: m, y: t };
                                    ...
                                    0 !==
                                        r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, m, t, f), A.push(s), aa = Q(aa), u && A.push({ x: m, y: t, ctx: l, type: s.type, size: s.size, color: aa, borderColor: aa, borderThickness: s.borderThickness }));
                        ...
                        for (; h < r.length; h++)
                            if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                ...
                                "number" !== typeof r[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(r[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(),
                                    ...
                                    g.lineThickness))) : (S = g.lineDashType, f.setLineDash(D)))), s = g.dataPointIds[h], this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: m, y1: t }, 0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (aa = g.getMarkerProperties(h, m, t, f), A.push(aa), s = Q(s), u && A.push({ x: m, y: t, ctx: l, type: aa.type, size: aa.size, color: s, borderColor: s, borderThickness: aa.borderThickness })), (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "stepArea",
                                    dataPoint: r[h],
                                    dataSeries: g,
                                    point: { x: m, y: t },
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) z.connectNullData || (aa || x) || d(), aa = !0;
                                    ...
                                    x || aa ? (!x && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || E === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (x = k.pop(), E = k[k.length - 1], d(), b.moveTo(t.x, t.y), k.push(E), k.push(x), E = z.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g,
                                        r), u && s.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), u && (s.beginPath(), s.moveTo(g, r))), aa = x = !1) : (b.lineTo(g, r), u && s.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), u && s.moveTo(g, r), k.push({ x: g, y: m - ma })));
                                    t = { x: g, y: r };
                                    q < w.length - 1 && (S !== (w[q].lineColor || y) || E !== (w[q].lineDashType || z.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({ x: g, y: m - ma }), S = w[q].lineColor || y, b.strokeStyle = S, b.setLineDash && (w[q].lineDashType ? (E = w[q].lineDashType, b.setLineDash(N(E, z.lineThickness))) : (E = z.lineDashType, b.setLineDash(D))));
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ma = z.getMarkerProperties(z.dataPointIndexes[f], g, r, b), l.push(ma), f = Q(F), u && l.push({ x: g, y: r, ctx: s, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) z.connectNullData ||
                                    ...
                                    s || aa ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || t === z.lineDashType &&
                                        z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), t = k[k.length - 1], d(), b.moveTo(m.x, m.y), k.push(t), k.push(s), t = z.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, r), u && E.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), u && (E.beginPath(), E.moveTo(g, r))), aa = s = !1) : (b.lineTo(g, r), u && E.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), u && E.moveTo(g, r), k.push({ x: g, y: x - ba })));
                                    m = { x: g, y: r };
                        ...
                        if (0 < C.length)
                            for (var F = B._colorSet, v = 0; v < C.length; v++) {
                                ...
                                if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(C[v].y) && C[v].y.length && "number" === typeof C[v].y[0] && "number" === typeof C[v].y[1]) {
                                    ...
                                    b && n > p && (ja = n, n = p, p = ja);
                                    ja = B.dataPointIds[v];
                                    this._eventManager.objectMap[ja] = { id: ja, objectType: "dataPoint", dataSeriesIndex: E, dataPointIndex: v, x1: Math.min(n, p), y1: Math.min(q, g), x2: Math.max(p, n), y2: Math.max(g, q), isXYSwapped: b, stemProperties: P, whiskerProperties: S };
                                    y(c, Math.min(n, p),
                        ...
                        for (var S = !0; g < p.length; g++)
                            if (t = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    if (p[g].indexLabel || n.indexLabel || p[g].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: n, indexKeyword: 0, point: { x: r, y: s }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: E }), this._indexLabels.push({
                                        chartType: "rangeArea",
                                        dataPoint: p[g],
                                        dataSeries: n,
                                        indexKeyword: 1,
                    ...
                    if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                        ...
                        if (-1 !== P) {
                            ...
                            for (G = 0; G < P.length - 1; G++) U = t.reversed ? x[x.length - 1 - G].color ? x[x.length - 1 - G].color : t._colorSet[(x.length - 1 - G) % t._colorSet.length] : x[G].color ? x[G].color : t._colorSet[G % t._colorSet.length],
                                G === ca ? O.push({ x1: a[G], y1: F[G], x2: C[G], y2: F[G], x3: W, y3: xa, x4: C[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: K, y6: xa, id: G, height: F[G + 1] - F[G], color: U }) : O.push({ x1: a[G], y1: F[G], x2: C[G], y2: F[G], x3: C[G + 1], y3: F[G + 1], x4: a[G + 1], y4: F[G + 1], id: G, height: F[G + 1] - F[G], color: U });
                            var da = 2,
                                I = [],
                                ha = !1,
                                X = [],
                            ...
                            if (H && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) { l(); for (G = 0; G < x.length; G++) I[G].isDirty || (a = I[G].textBlock.x + I[G].width, a = (J - a) / 2, 0 == G && (z = a), z > a && (z = a)); for (G = 0; G < O.length; G++) O[G].x1 += z, O[G].x2 += z, O[G].x3 += z, O[G].x4 += z, O[G].x5 && (O[G].x5 += z, O[G].x6 += z), I[G].textBlock.x += z }
